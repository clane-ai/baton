...
// useT() returns { lang, setLang, t }; t(key, vars) reads the English table with {{var}} interpolation.
...
const table: Record<string, string> = (APPROVALS as { en: Record<string, string> }).en;
